...
Here, we present VCF Core Vocabulary 2.1.2~\cite{vcfc210}, developed from our earlier VCF-RDFizer Vocabulary~\cite{crum2025semantifying}.
...
VCF-RDFizer supplies an implementation: the cited release emits the VCF Core namespace, but on the inputs tested rather than as evidence of complete VCF Core 2.1.2 support~\cite{vcfrConverter2026}.
