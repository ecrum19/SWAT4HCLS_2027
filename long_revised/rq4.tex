...
VCF2RDF's terms were inspected, while converter behaviour was taken from the VCF2RDF paper rather than execution.
...
GFVO directly models field meanings such as \term{AlleleCount} and \term{MappingQuality}, but leaves the declaration mechanism out of scope~\cite{baran2015gfvo}.
...
GVO's predominantly S verdicts reflect the GVO focus on classifying biological variation rather than representing source-file relationships.

\begin{table}[htbp]
\caption{Support in inspected artifacts: E, explicitly represented; C, representable with additional conventions; S, outside stated scope. These are inspection judgments about VCF interpretation context.}
\label{tab:models}
\centering\small
...
\midrule
F1\quad trace a record to the source file & E & E & E & S & C \\
...
F7\quad bind a \texttt{Number=A/R} item to the allele & E & C & C & S & C \\
...
Separately, VCF Core provides \textbf{123 curated alignments}\footnote{\url{https://github.com/ecrum19/vcf-core-vocabulary/tree/v2.1.3/mappings}}, recorded in SSSOM with SKOS predicates: 57 exact, 40 close, 16 related, and 10 narrow matches~\cite{matentzoglu2022sssom,skos2009}.
