...
> **To what extent does VCF Core preserve and represent what is defined in the VCF specification (including file and header context, allele-dependent field values, sample genotypes and phasing, version-specific constructs, etc.)?**
