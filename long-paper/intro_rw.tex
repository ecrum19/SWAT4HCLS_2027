...
% TODO: fix where this paragraph fits
...
% TODO: Motivation idea --> complex variant info is interesting for medical and research uses but it requires the attached metadata and ... to be useful. Here we want to model those fields semantically to made semantic VCF data more useful for downstream applications.
