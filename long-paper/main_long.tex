...
A semantic round-trip recovers the fixed columns and genotypes of all 109 records, in the expanded profile, from structured properties alone, and one integration example answers an allele-dependent question under VCF 4.5 local alleles with checked answers and recovered provenance. 
